    ...
    const drawerContent = (
        <Box sx={{ width: 280, bgcolor: '#121212', height: '100%', color: '#ffffff' }} role="presentation">
            ...
            <List component="nav" sx={{ 
                ...
                <ListItem disablePadding>
                    <ListItemButton component={Link} to="/stores" onClick={handleDrawerToggle}>
                ...
                {/* Equipos de computo */}
                <ListItem disablePadding>
                    <ListItemButton onClick={() => handleMobileSubmenu('equipos')}>
                ...
                <Collapse in={mobileSubmenus['equipos']} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem disablePadding>
                            <ListItemButton sx={{ pl: 4 }} component={Link} to="/category/Computadoras" onClick={handleDrawerToggle}>
                                <ListItemText primary="Computadoras" />
                            </ListItemButton>
                        </ListItem>
                        <ListItem disablePadding>
                            <ListItemButton sx={{ pl: 4 }} component={Link} to="/category/Laptops" onClick={handleDrawerToggle}>
                                <ListItemText primary="Laptops" />
                            </ListItemButton>
                        </ListItem>
                        <ListItem disablePadding>
                            <ListItemButton sx={{ pl: 4 }} component={Link} to="/category/Tablets" onClick={handleDrawerToggle}>
                ...
                <ListItem disablePadding>
                    <ListItemButton component={Link} to="/category/Impresoras" onClick={handleDrawerToggle}>
                ...
                {/* Catálogos */}
                <ListItem disablePadding>
                    <ListItemButton onClick={() => handleMobileSubmenu('catalogos')}>
                ...
                <Collapse in={mobileSubmenus['catalogos']} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem disablePadding>
                            <ListItemButton sx={{ pl: 4 }} component={Link} to="/category/Tintas" onClick={handleDrawerToggle}>
                                <ListItemText primary="Tintas" />
                            </ListItemButton>
                        </ListItem>
                        <ListItem disablePadding>
                            <ListItemButton sx={{ pl: 4 }} component={Link} to="/category/SSD" onClick={handleDrawerToggle}>
                                <ListItemText primary="SSD" />
                            </ListItemButton>
                        </ListItem>
                        <ListItem disablePadding>
                            <ListItemButton sx={{ pl: 4 }} component={Link} to="/category/COMBO GAMER" onClick={handleDrawerToggle}>
                ...
                <ListItem disablePadding>
                    <ListItemButton component={Link} to="/internet" onClick={handleDrawerToggle}>
                ...
                <ListItem disablePadding>
                    <ListItemButton onClick={() => handleMobileSubmenu('atencion')}>
                ...
                <Collapse in={mobileSubmenus['atencion']} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem disablePadding>
                            <ListItemButton sx={{ pl: 4 }} component={Link} to="/cameras" onClick={handleDrawerToggle}>
                                <ListItemText primary="Camara de vigilancia" />
                            </ListItemButton>
                        </ListItem>
                        <ListItem disablePadding>
                            <ListItemButton sx={{ pl: 4 }} component={Link} to="/soporte" onClick={handleDrawerToggle}>
                                <ListItemText primary="Soporte técnico" />
                            </ListItemButton>
                        </ListItem>
                        <ListItem disablePadding>
                            <ListItemButton sx={{ pl: 4 }} component={Link} to="/clients" onClick={handleDrawerToggle}>
                ...
                {isAuthenticated ? (
                    <>
                        ...
                        <ListItem disablePadding>
                            <ListItemButton component={Link} to="/client/orders" onClick={handleDrawerToggle}>
