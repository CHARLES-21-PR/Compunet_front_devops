    ...
    return (
        <>
            ...
            <Box sx={{ 
                ...
                pointerEvents: 'none' // <--- IMPORTANTE: Para que el contenedor no bloquee clicks
            }}>
                
                {/* Tarjeta con efecto de DESVANECIMIENTO y ZOOM */}
                <Zoom in={open} timeout={{ enter: 500, exit: 300 }} unmountOnExit>
                    <Card sx={{ 
                        mb: 2, 
                        width: 300, 
                        ...
                        pointerEvents: 'auto' // <--- Reactivar clicks en la tarjeta
                    }}>
                        {/* Cabecera */}
                        <Box sx={{ 
                ...
                <IconButton 
                    ...
                    sx={{ 
                        ...
                        pointerEvents: 'auto', // <--- Reactivar clicks en el botón
                        '&:hover': { 
                            bgcolor: '#128C7E',
